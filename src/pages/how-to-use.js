            ...
            <div className={"features"}>
                    ...
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/openMenu.mp4"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/dragDrop.mp4"} className={"hidden-sm"} />
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/dragPinned.mp4"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/resizeMenu.mp4"} className={"hidden-sm"} />
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/collapse.mp4"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/contextMenuNormal.mp4"} className={"hidden-sm"} />
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/contextMenuPin.mp4"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>

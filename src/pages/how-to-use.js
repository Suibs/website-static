            ...
            <div className={"features"}>
                    ...
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/openMenu.mov"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/dragDrop.mov"} className={"hidden-sm"} />
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/dragPinned.mov"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/resizeMenu.mov"} className={"hidden-sm"} />
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/collapse.mov"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/contextMenuNormal.mov"} className={"hidden-sm"} />
                ...
                <div className={"feature__item"}>
                    <div className={"row"}>
                        ...
                        <div className={"col-6 first"}>
                            <div className={"thumbnail"}>
                                <video preload='auto' autoPlay muted loop src={"https://treestyletab.s3.eu-west-3.amazonaws.com/contextMenuPin.mov"} className={"hidden-sm"} />
                            </div>
                        </div>
                    </div>
                </div>
